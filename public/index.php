...
require_once '../app/model/Proyecto.php';
...
<body>
    ...
    <div class="container">
        ...
        <div class="sidebar">
            <ul class="menu">
                <li onclick="location.href='../app/views/tareas/tareas.php'">Notificaciones</li>
                <li onclick="location.href='../app/views/informes/informes.php'">Informes</li>
            </ul>
            <div class="projects">
            ...
            <div class="logout-container">
                <button class="logout-btn" onclick="location.href='../app/views/auth/logout.php'">Cerrar Sesión</button>
            </div>
        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            inputResponsable.addEventListener("input", async () => {
                ...
                try {
                    const response = await fetch(`../app/helpers/search_responsable.php?query=${query}`);
            ...
            pedidoForm.addEventListener('submit', async (e) => {
                ...
                try {
                    const url = id ? '../app/views/pedidos/edit_pedido.php' : '../app/views/pedidos/save_pedido.php';
            ...
            proyectoForm.addEventListener('submit', async (e) => {
                ...
                try {
                    const response = await fetch('../app/views/proyectos/save_proyecto.php', {
                        method: 'POST',
                        body: formData
                    });
    ...
    try {
        const response = await fetch(`../app/views/pedidos/get_pedido.php?id=${id}`);
        ...
        async function eliminarPedido(id) {
            ...
            try {
                ...
                const response = await fetch('../app/views/pedidos/delete_pedido.php', {
                    method: 'POST',
                    body: formData
                });
