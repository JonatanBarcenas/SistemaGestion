...
<body>
    ...
    <div class="container">
         ...
         <div class="sidebar">
            <ul class="menu">
                <li onclick="location.href='../tareas/tareas.php'">Notificaciones</li>
    ...
    try {
        window.location.href = `exportar_informe.php?tipo=${tipo}`;
    } catch (error) {
        ...
        function cambiarProyecto(proyectoId) {
            window.location.href = `../../../public/index.php?proyecto_id=${proyectoId}`;
        }
    </script>
